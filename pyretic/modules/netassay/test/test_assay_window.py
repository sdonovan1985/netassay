...
from pyretic.modules.netassay.netassaywindow import *
import logging
...
# python pyretic.py -m p0 pyretic.modules.netassay.test.test_assay_window
# h1 ping yahoo.com
# h1 ping google.com
...
class TestAssay(DynamicPolicy):
    def __init__(self):
        ...
        self.assay_naw = NetAssayWindow.get_instance()
        ...
        self.URLs1rules = ((match(switch=1, inport=1) >> fwd(3)) +
                           ...
                           (match(switch=1, inport=3) >> 
                            if_(visited(30, domain='google.com'), fwd(1), fwd(2))))
    ...
    def update_policy(self):
        ...
        vanilla_policy = self.s1rules + self.s2rules + self.s3rules + self.s4rules + self.assay_naw.get_forwarding_rules()
